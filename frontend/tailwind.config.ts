    ...
    extend: {
      ...
      colors: {
        ...
        civic: {
          ...
          "gray-400": "hsl(var(--civic-gray-400))",
          "gray-500": "hsl(var(--civic-gray-500))",
          "gray-600": "hsl(var(--civic-gray-600))",
          "gray-700": "hsl(var(--civic-gray-700))",
          "gray-800": "hsl(var(--civic-gray-800))",
          "gray-900": "hsl(var(--civic-gray-900))",
        },
        sidebar: {
      ...
      boxShadow: {
        ...
        'civic-card-hover': 'var(--shadow-card-hover)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
